...
const projects: Project[] = [
  {
    ...
    desc: "Sitio corporativo para un taller especializado en mecánica y diagnóstico electrónico automotriz. Captación por WhatsApp, galería y proceso del taller.",
  ...
  },
  {
    ...
    desc: "Web para un taller con +15 años de experiencia en pailas ganaderas, maquinaria agrícola y soldadura de arco eléctrico.",
